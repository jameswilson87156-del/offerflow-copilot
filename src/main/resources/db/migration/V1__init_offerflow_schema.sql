-- OfferFlow Copilot initial schema.
-- Kept to portable H2/MySQL types: VARCHAR, TEXT, INT, BOOLEAN and TIMESTAMP.
...
CREATE TABLE resume_evidence_audit_event (
    id VARCHAR(80) PRIMARY KEY,
...
CREATE TABLE jd_evidence_binding (
...
CREATE TABLE match_report_version (
    id VARCHAR(80) PRIMARY KEY,
...
CREATE TABLE match_report_audit_event (
    id VARCHAR(80) PRIMARY KEY,
...
CREATE TABLE human_review_audit_event (
    id VARCHAR(80) PRIMARY KEY,
...
CREATE TABLE provider_trace_run (
    id VARCHAR(80) PRIMARY KEY,
